...
@Component({
  ...
  templateUrl: './views/sections.component.html',
})

export class SectionsComponent implements OnInit {

  @ViewChild(DatatableComponent) table: DatatableComponent;
  public rows = new Array<Section>();
  ...
  constructor(private router: Router, private route: ActivatedRoute, private toastr: ToastrService,
    vcr: ViewContainerRef, private service: SectionService) {
  }

  onAdd() {
    this.router.navigate(['/admin/organisation/addSection'], { relativeTo: this.route });
  }

  onEdit(id: number) {
    this.router.navigate(['/admin/organisation/addSection', id], { relativeTo: this.route });
    // Emit edit event
