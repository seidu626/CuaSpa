...
@Component({
  ...
  templateUrl: './views/member-types.component.html',
})
export class MemberTypesComponent implements OnInit {

  public rows: MemberType[]
  ...
  constructor(private router: Router, private route: ActivatedRoute, private toastr: ToastrService,
    vcr: ViewContainerRef, private service: MemberTypeService) {
  }

  onAdd() {
    this.router.navigate(['/admin/employees/addMemberType'], { relativeTo: this.route });
  }

  onEdit(id: number) {
    this.router.navigate(['/admin/employees/addMemberType', id], { relativeTo: this.route });
    // Emit edit event
