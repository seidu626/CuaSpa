...
@Component({
  ...
  templateUrl: './views/permissions.component.html'
})
export class PermissionsComponent implements OnInit {

  public rows: Permission[]
  ...
  constructor(private router: Router, private route: ActivatedRoute, private toastr: ToastrService,
    vcr: ViewContainerRef, private service: PermissionService) {
  }

  onAdd() {
    this.router.navigate(['/admin/security/addPermission'], { relativeTo: this.route });
  }

  onEdit(id: number) {
    this.router.navigate(['/admin/security/addPermission', id], { relativeTo: this.route });
    // Emit edit event
